...
impl Command {
    pub fn list() -> &'static [Command] {
        ...
        &[
            ...
            C::ReadAvailableData,
            C::Kill,
            // C::BaudRate(BaudRate::Baud1200),
            // C::BaudRate(BaudRate::Baud2400),
            // C::BaudRate(BaudRate::Baud4800),
            // C::BaudRate(BaudRate::Baud9600),
            // C::BaudRate(BaudRate::Baud19200),
            // C::BaudRate(BaudRate::Baud38400),
            // C::BaudRate(BaudRate::Baud57600),
            C::PollingMode,
            C::ContinousMode,
    ...
    pub fn name(self) -> &'static CStr {
        match self {
            ...
            Command::Kill => c"Kill",
            Command::BaudRate(BaudRate::Baud1200) => c"Set Baud Rate to 1200",
            Command::BaudRate(BaudRate::Baud2400) => c"Set Baud Rate to 2400",
            Command::BaudRate(BaudRate::Baud4800) => c"Set Baud Rate to 4800",
            Command::BaudRate(BaudRate::Baud9600) => c"Set Baud Rate to 9600",
            Command::BaudRate(BaudRate::Baud19200) => c"Set Baud Rate to 19200",
            Command::BaudRate(BaudRate::Baud38400) => c"Set Baud Rate to 38400",
            Command::BaudRate(BaudRate::Baud57600) => c"Set Baud Rate to 57600",
